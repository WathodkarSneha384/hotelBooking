const HotelCard = ({hotel}) =>{
    return (
        <div className="card" style={{width:'13rem', marginBottom:'30px'}}>
            <img className="card-img-top" src={hotel.image} alt={hotel.name} style={{height:'200px'}}/>
            <div className="card-body">
             ...
             <div>
                <h2 className='text text-success' style={{marginBottom:'10px' ,marginLeft:'10px', textAlign:'center'}}>Quick View</h2>
             </div>
        </div>
